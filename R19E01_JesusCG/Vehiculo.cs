    ...
    public class Vehiculo
    {
        ...
        public TipoVehiculo TVehiculo
        {
            ...
            set
            {
                ...
                // if (!TIPOS_VEHICULOS.Contains(value)) throw new Exception("Tipo de vehículo incorrecto");
        ...
        /// </summary>
        public TipoCombustible Combustibl
        {
            get { return _combustible;}
            set
            {
                // Comprobación de dato correcto
                // if (!COMBUSTIBLES.Contains(value)) throw new Exception("Combustible incorrecto");
        ...
        /// Estado del vehículo
        /// </summary>
        public EstadoVehiculo Estad
        {
            get { return _estado; }
            set
            {
                // Comprobación de dato correcto
                //if (!ESTADOS.Contains(value)) throw new Exception("Estado incorrecto");
